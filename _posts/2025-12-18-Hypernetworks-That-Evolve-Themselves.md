...
<video controls width="720" preload="metadata">
  <source src="{{ '/assets/videos/hypernets/GHN_PP_video_mid.mp4' | relative_url }}" type="video/mp4">
</video>
...
<video controls width="720" preload="metadata">
  <source src="{{ '/assets/videos/hypernets/GHN_architecture_1sec.mp4' | relative_url }}" type="video/mp4">
</video>
...
<video controls width="720" preload="metadata">
  <source src="{{ '/assets/videos/hypernets/grid_all_2d.mp4' | relative_url }}" type="video/mp4">
</video>
